...
module.exports = function(grunt) {
  grunt.initConfig({
    sass: {
      dist: {
        files: {
          'css/streamone-icons.css': 'scss/streamone-icons-codepoints.scss'
        }
      }
    },
    watch: {
  ...
  grunt.registerTask('wrapcodepoints', function() {
    const cssPath = path.normalize('./css/streamone-icons.css');
  ...
  grunt.registerTask('update-base64', function() {
    ...
    let fontFiles = {
      ttf: './fonts/StreamOne.ttf',
      woff: './fonts/StreamOne.woff'
    };
